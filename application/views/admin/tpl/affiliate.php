...
<header id="topbar" class="affix">
        ...
        <li class="crumb-icon">
                <a href="http://demothu.web5s.com.vn/admin.html" title="">
                        <span class="glyphicon glyphicon-home"></span>
                                ...
                                <li >
                        <a href="http://demothu.web5s.com.vn/admin/affiliate.html">Cộng tác viên</a>
                </li>
                        <li class="current">
                        <a href="">Danh sách</a>
                </li>
        ...
        <div class="topbar-right">
                ...
                <a class="btn btn-success fw600 pull-right br3 pv5 hidden-xs" href="http://demothu.web5s.com.vn/admin/affiliate.html">
...
<section id="content">
	<div class="panel">
		...
		<form action="http://demothu.web5s.com.vn/admin/affiliate.html" method="get" class="form" name="filter">
                        <table class="footable table table-striped table-hover table-bordered admin-form fs13">
                                <thead>
                                        <tr class="customer">
                                                ...
                                                <th class="w150" data-hide="phone">Doanh thu</th>
                                                <th class="w150" data-hide="phone">Số dư</th>
